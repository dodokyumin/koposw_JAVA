...
public class Test01 {
	...
	public static void main(String[] args) {		
		...
		Date k44_now = new Date();
		Calendar k44_cal2 = Calendar.getInstance(); 
		k44_cal2.setTime(k44_now);
		k44_cal2.add(Calendar.DATE, 14); //14일 더하기
		int k44_month = k44_cal2.get(Calendar.MONTH) + 1; //0부터 시작하기 때문에 1더해준다
		int k44_day = k44_cal2.get(Calendar.DAY_OF_MONTH);
		...
		System.out.printf("%s\n","대표:홍규민,규민홍 213-81-52063");
		System.out.printf("%s\n%s\n","매장:경기도 성남시 분당구 분당로53번길 11 (서현","동)");
		System.out.printf("================================================\n");
		System.out.printf("%27s\n","소비자중심경영(CCM) 인증기업");
		System.out.printf("%29s\n","ISO 9001 품질경영시스템 인증기업");
		System.out.printf("================================================\n");
		System.out.printf("%19s%02d%s%02d%s\n","교환/환불 14일(",k44_month,"월",k44_day,"일)이내,");
		...
		System.out.printf("================================================\n");
		System.out.printf("%s%,9d%4d%,9d\n[%s]\n",Test01.k44_substringByBytes(k44_itemname1, 0, 27),k44_price1, k44_amount1, k44_price1*k44_amount1,k44_itemcode1);	
		System.out.printf("%s%,9d%4d%,9d\n[%s]\n",Test01.k44_substringByBytes(k44_itemname2, 0, 27),k44_price2, k44_amount2, k44_price2*k44_amount2,k44_itemcode2);
		System.out.printf("%s%,9d%4d%,9d\n[%s]\n",Test01.k44_substringByBytes(k44_itemname3, 0, 27),k44_price3, k44_amount3, k44_price3*k44_amount3,k44_itemcode3);
